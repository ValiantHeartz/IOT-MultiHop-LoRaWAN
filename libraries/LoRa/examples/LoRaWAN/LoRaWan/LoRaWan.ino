...
static void prepareTxFrame( uint8_t port )
{
	...
	*/
    appDataSize = 23;
    //uint8_t temp = random(0,250);
	uint8_t payload[appDataSize] = {3,15,43,34,27,2,23,1,1,0,56,0,0,1,12,37,22,61,11,87,95,0,3};
	for(uint8_t i = 0; i < appDataSize; ++i){
		appData[i] = payload[i]*(1+0.01*(random(0,20)-10));
